...
| Process | First layer height | `ProfileModels.kt` `ProcessProfile.firstLayerHeightMm` | `initial_layer_print_height`, `first_layer_height` | Planned | Planned | Partial | Prefer canonical Orca initial-layer height key | Export as canonical Orca initial-layer height key | Keep alias handling documented | Device tested |
...
| Process | Skirts | `ProfileModels.kt` `ProcessProfile.skirts` | `skirt_loops`, `skirts` | Planned | Planned | Partial | Prefer canonical Orca skirt-loop key | Export as canonical Orca skirt-loop key | Keep alias handling documented | Device tested |
