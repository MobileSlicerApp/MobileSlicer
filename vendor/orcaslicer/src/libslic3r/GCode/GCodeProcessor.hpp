...
// ORCA: Add Pressure Advance visualization support
        ...
        std::vector<size_t> mobile_preview_layer_vertex_counts;
        ...
        size_t mobile_after_setup_rss_kb{0};
        size_t mobile_after_layers_rss_kb{0};
        size_t mobile_after_footer_rss_kb{0};
        ...
        GCodeProcessorResult& operator=(const GCodeProcessorResult &other)
        {
            ...
            mobile_preview_layer_vertex_counts = other.mobile_preview_layer_vertex_counts;
            ...
            mobile_after_setup_rss_kb = other.mobile_after_setup_rss_kb;
            mobile_after_layers_rss_kb = other.mobile_after_layers_rss_kb;
            mobile_after_footer_rss_kb = other.mobile_after_footer_rss_kb;
