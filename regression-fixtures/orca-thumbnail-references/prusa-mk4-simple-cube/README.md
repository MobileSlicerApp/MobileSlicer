...
OrcaSlicer unknown`
- Source package: `prusa-mk4-simple-cube.gcode.3mf`
- Model: `/home/peanut/Development/MobileSlicer/regression-fixtures/slicing/mobileslicer_test_cube.stl`
- Printer profile: `Prusa MK4 0.4 nozzle`
- Filament profile: `Prusa Generic PLA @MK4`
- Process profile: `0.20mm Standard @MK4`
